...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_siema__ = __webpack_require__(3);
...
if (elementExists('#quotes')) {
    var quotes = new __WEBPACK_IMPORTED_MODULE_0_siema___default.a({
        selector: '#quotes',
        duration: 300,
        loop: true,
        easing: 'ease-out',
...
if (elementExists('#flows')) {
    var flows = new __WEBPACK_IMPORTED_MODULE_0_siema___default.a({
        selector: '#flows',
        duration: 200,
        easing: 'ease-out'
    });
...
if (elementExists('.products')) {
    var products = new __WEBPACK_IMPORTED_MODULE_0_siema___default.a({
        selector: '.products',
        duration: 200,
        easing: 'ease-out'
    });
    document.querySelector('#products .button.prev').addEventListener('click', function () {
        return products.prev();
    });
    document.querySelector('#products .button.next').addEventListener('click', function () {
